...
function BlindBoxOffChain(props) {
  ...
  const getBoxes = async () => {
    let url =
      networkType === "testnet"
        ? `https://testapi.xanalia.com/xanaGenesis/get-public-sale-data?id=${props.match.params.collId}`
        : `https://api.xanalia.com/xanaGenesis/get-public-sale-data?id=${props.match.params.collId}`;
  ...
  const buyNFTItem = async () => {
    ...
    if (connectedWithTo) {
      ...
      if (selectedRangeToBuy && parseInt(selectedRangeToBuy) > 100) {
            ...
            <>
              <div className="collectionUiBody">
                ...
                <Card className="collectionProfileCard">
                  ...
                  <Card.Body>
                    <Card.Title>
                      {selectedBlindBox && selectedBlindBox.collectionName}
                    </Card.Title>
                  ...
                  <div className="collectionProductUI">
                    ...
                    <div className="collectionProductDetails">
                      ...
                      <h2 className="whiteTxt">
                        ...
                        <span className="currencyName whiteTxt">
                        ...
                        <span className="dollerValueTxt whiteTxt">
                          {selectedRound?.priceOnChain > 0 &&
                            "($" +
                              insertComma(
                      ...
                      new Date().getTime() >=
                        ...
                        <>
                          <span className=" whiteTxt">Ending After</span>
                          <CountDown
                                  ...
                                  <>
                                    ...
                                    rangeToBuy !== "" ? (
                                      rangeToBuy.length > 0 ? (
                                        ...
                                        <input
                                          className="form-control input-fix"
                                          type="text"
                      ...
                      <div className="mt-auto mb-0 collectionProductTabs">
                        ...
                        >
                          ...
                          <Tab eventKey="CollectionId" title="Collection">
                            <h3>
                              {selectedBlindBox &&
                                selectedBlindBox.collectionName}
                            </h3>
